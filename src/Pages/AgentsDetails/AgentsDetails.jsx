        ...
        <div className="lg:flex lg:justify-between 2xl:gap-[121px]">
          <div className="lg:w-[550px] w-full 2xl:h-[783px] lg:h-[650px] md:h-[700px] relative">
            <Zoom>
              <div className="group relative">
                ...
                <div className="bg-[#442AE2] w-[160px] h-[140px] absolute bottom-[-19px] left-[-19px] z-[-1] "></div>
                <div className="bg-[#442AE2] w-[160px] h-[140px] absolute top-[-19px] right-[-19px] z-[-1] "></div>

                <div className="bg-[#181C21] lg:w-[550px] w-full h-[150px] absolute bottom-0  cursor-pointer">
          ...
          <Fade bottom cascade>
            <div className="2xl:w-[691px] lg:w-[630px] w-full mt-16 md:mt-16 lg:mt-0 2xl:mt-6">
              <h1 className="text-[#504594] text-[32px] font-Teko font-bold leading-8">
                Jone Michal
              </h1>

              <p className="text-black text-[20px] font-Lato font-bold leading-8 mt-3">
                Real Estate Agents
              </p>

              <p className="2xl:w-[691px] lg:w-[630px] w-full text-[#4E5A6] text-[16px] font-Lato font-normal mt-10">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                Facilis aspernatur, aliquid explicabo veniam earum provident?
                Quia eaque adipisci, pariatur vero provident neque in voluptatem
                enim ut libero asperiores tempore consectetur?
              </p>
              ...
              <p className="2xl:w-[691px] lg:w-[630px] w-full text-[#4E5A6] text-[16px] font-Lato font-normal mt-10">
                ...
                Facilis aspernatur, aliquid explicabo veniam earum provident?
                Quia eaque adipisci, pariatur vero provident neque in voluptatem
                enim ut libero asperiores tempore consectetur? Quia eaque
                adipisci, pariatur vero provident neque in voluptatem enim ut
                libero asperiores tempore consectetur?
              </p>
              ...
              <p className="2xl:w-[691px] lg:w-[630px] w-full text-[#4E5A6] text-[16px] font-Lato font-normal mt-10 2xl:block hidden">
                ...
                Facilis aspernatur, aliquid explicabo veniam earum provident?
                Quia eaque adipisci, pariatur vero provident neque in voluptatem
                enim ut liberoQuia eaque adipisci, pariatur vero provident neque
                in voluptatem enim ut libero
              </p>
