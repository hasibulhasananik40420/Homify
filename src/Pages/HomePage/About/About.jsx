  ...
  return (
    ...
    <div className="max-w-container mx-auto lg:px-8 2xl:px-0 px-4 md:px-4 pt-32">
      <div className="lg:flex 2xl:flex lg:gap-[50px] 2xl:gap-[50px] justify-between">
        <div className="2xl:w-[603px] lg:w-[603px] md:[500px] w-full md:mx-auto">
          <img
            className="2xl:w-[603px] lg:w-[603px] md:[500px] w-full md:mx-auto 2xl:h-[479px] lg:[479px] md:h-[479px] h-full"
            src={about}
            alt=""
          />
        </div>
