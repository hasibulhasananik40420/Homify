    ...
    <div>
      ...
      <NavbarTwo />
        <div className="lg:flex 2xl:gap-14 lg:gap-20  mx-auto lg:px-8 2xl:px-8 px-4 md:px-8">
         ...
         <div className="2xl:mt-16 lg:mt-[40px] md:mt-[90px] 2Issue:mt-2 mt-[50px] w-full">
         ...
         <div className="w-full">
          <img className="2xl:w-[730px] 2Issue:h-[550px] 2Issue:mt-[36px] 2xl:h-[650px] lg:w-[560px] lg:h-[500px] md:w-[600px] md:h-[520px] md:mx-auto lg:mx-0 2xl:mx-0  md:mt-24 md:mb-24 mb-24 lg:mb-0 2xl:mb-0 lg:mt-2 2xl:mt-2 mt-20 w-full h-full" src={heroImage} alt="" />
         </div>
