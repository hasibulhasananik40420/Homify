...
const Header = () => {
  return (
    <div>
      <div className="header-image 2xl:h-[100vh] lg:h-[105vh] h-full bg-cover bg-fixed bg-no-repeat bg-center flex flex-col justify-center items-center">
      <NavbarTwo />
        <div className="lg:flex 2xl:gap-14 lg:gap-20  mx-auto lg:px-8 2xl:px-8 px-4 md:px-8">

         <div className="2xl:mt-16 lg:mt-[80px] md:mt-[150px] mt-[150px] w-full">
