...
const Header = () => {
  return (
    <div>
      ...
      <NavbarTwo />
        <div className="lg:flex 2xl:gap-14 lg:gap-20 max-w-[1680px] mx-auto lg:px-8 2xl:px-8 px-4 md:px-8">
         ...
         <div className="w-full">
          <img className="2xl:w-[803px] 2xl:h-[703px] lg:w-[580px] lg:h-[520px] md:w-[600px] md:h-[520px] md:mx-auto lg:mx-0 2xl:mx-0  md:mt-24 md:mb-24 mb-24 lg:mb-0 2xl:mb-0 lg:mt-20 2xl:mt-2 mt-20 w-full h-full" src={heroImage} alt="" />
         </div>
