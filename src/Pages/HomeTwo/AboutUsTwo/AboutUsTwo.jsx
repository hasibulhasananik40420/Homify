      ...
      <div>
        ...
        <div className="lg:flex 2xl:gap-[121px] lg:gap-20">
          ...
          <div className="2xl:w-[735px] lg:w-[670px] w-full">
            ...
            <p className="text-black text-[16px] font-Lato font-normal leading-8 mt-2 lg:mt-0 2xl:mt-0">
            ...
            >
              <div className="lg:flex items-center gap-8 2xl:p-7 lg:p-4 md:p-6 p-4">
                ...
                <span>
                  ...
                  <p className="text-[#263238] text-[16px] font-Lato font-normal leading-8 mt-3 md:mt-3 lg:mt-0 2xl:mt-0 group-hover:text-white">
            ...
            <button className="bg-[#F90] text-white text-[16px] mt-[32px] font-Lato font-normal w-[170px] h-[56px]  hover:bg-[#375E97] duration-500">
            Read More
          </button>
          </div>
