    ...
    <div className="">
      ...
      <div className="lg:flex items-center gap-24 2xl:py-32 lg:py-[100px] md:py-20 py-16 max-w-container mx-auto lg:px-8 2xl:px-0 px-4 md:px-8 ">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }}
          ...
          <Link className="text-black text-center mt-[40px] text-[16px] font-Lato font-normal" to={'/sign-up'}>Don’t have any account ? <span className="text-black  text-[16px] font-Lato font-bold">Sign Up now</span></Link>
        </motion.div>
      </div>
