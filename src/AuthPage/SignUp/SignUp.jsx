    ...
    <div className="">
      ...
      <div className="lg:flex items-center gap-24 2xl:py-32 lg:py-[100px] md:py-20 py-16 max-w-container mx-auto lg:px-8 2xl:px-0 px-4 md:px-8 ">
        ...
        <div className="flex flex-col md:mx-auto md:mt-10 lg:mt-0 mt-10 2xl:mt-0 md:w-[500px] w-full">
            ...
            <div className=" lg:w-[429px] md:w-[500px] w-full">
              <div className="mt-5">
                <div className="flex gap-4 items-center">
                  ...
                  I am agree your <span className="text-[16px] font-Lato text-black font-bold leading-6">Terms and Conditions</span>
                  </p>
                </div>
              </div>
          ...
          <Link className="text-black mt-[20px] text-[16px] font-Lato font-normal" to={'/login'}>If you already have an account ? <span className="text-black  text-[16px] font-Lato font-bold">Sign In </span></Link>
